...
def test_apache():
    ...
    line_0 = {'host': '83.149.9.216', 'user': '-', 'date': '17/May/2015:10:05:03 +0000', 'request': 'GET /presentations/logstash-monitorama-2013/images/kibana-search.png HTTP/1.1', 'status': '200', 'size': '203023'}
    line_10 = {'host': '83.149.9.216', 'user': '-', 'date': '17/May/2015:10:05:46 +0000', 'request': 'GET /presentations/logstash-monitorama-2013/images/Dreamhost_logo.svg HTTP/1.1', 'status': '200', 'size': '2126'}
    line_543 = {'host': '65.55.213.73', 'user': '-', 'date': '17/May/2015:15:05:44 +0000', 'request': 'GET /blog/tags/year%20review HTTP/1.1', 'status': '200', 'size': '34590'}
    line_6543 = {'host': '115.112.233.75', 'user': '-', 'date': '19/May/2015:16:05:23 +0000', 'request': 'GET /presentations/logstash-puppetconf-2012/images/xkcd-perl.png HTTP/1.1', 'status': '200', 'size': '80663'}
    ...
    line_0 = {'host': '93.180.71.3', 'user': '-', 'date': '17/May/2015:08:05:32 +0000', 'request': 'GET /downloads/product_1 HTTP/1.1', 'status': '304', 'size': '0', 'referer': '-', 'agent': 'Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)'}
